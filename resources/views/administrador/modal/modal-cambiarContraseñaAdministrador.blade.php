<div id="modal-cambiarContraseñaAdmin" uk-modal>
    <div class="uk-modal-dialog">
        <form method="post" action="{{route('editarAdmin',['admin_id'=>\Illuminate\Support\Facades\Route::current()->parameters()['admin_id']])}}">
            ...
            <div class="uk-modal-body">
                <p>Usted está a punto de cambiar la contraseña del administrador: {{\App\Models\User::find(\Illuminate\Support\Facades\Route::current()->parameters()['admin_id'])->name}}<span id="textoModalEliminarCobrador" class="uk-text-italic uk-text-uppercase"></span> </p>
                <div class="uk-margin">
